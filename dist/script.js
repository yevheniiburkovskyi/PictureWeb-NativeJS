...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])(".fixed-gift", ".popup-gift", ".popup-close");
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', "zoomIn", '.main-prev-btn', '.main-next-btn');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', "fadeInDown");
...
function modal(btn, selector, closeBtn) {
  ...
  var trigger = document.querySelectorAll(btn),
...
var scrolling = function scrolling() {
  ...
  var links = document.querySelectorAll('[href^="#"]'),
      // собирает все ссылки со страницы
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var widthTop = document.documentElement.scrollTop,
          // scrollTop возвращает количество пикселей, прокрученных от верха элемента
      hash = this.hash,
          toBlock = document.querySelector(hash).getBoundingClientRect().top,
          //возвращает размер элемента и его позицию относительно viewport (расстояние до него от верха в данном случае)
      start = null;
      requestAnimationFrame(step);

      function step(time) {
        // аргумент time передается автоматически
        if (start === null) {
          // проверяем первый ли раз запущена уже анимация
          start = time;
        }
...
var slider = function slider(sliders, animationStyle, prevBtn, nextBtn) {
  var slide = document.querySelectorAll(sliders);
  var slideIndex = 0;
  ...
  var showSlidesByIntervalActive = true;
...
var tabs = function tabs() {
  var tabsBtn = document.querySelectorAll('.portfolio-menu > li'),
